 ...
 * @Date: 2022-12-17 19:49:32
 * @LastEditors: Xu.WANG raymondmgwx@gmail.com
 * @LastEditTime: 2022-12-17 19:54:07
...
namespace PHY::RIGIDBODY
{
    ...
    public:
        ...
        void SetShape(const std::shared_ptr<Shape<RealType>> &shape) { mShape = shape; }

        void SetMass(RealType mass)
        {
            mMass = mass;
            mInverseMass = mMass ? static_cast<RealType>(1.0) / mMass : static_cast<RealType>(0.0);
        }
        ...
        friend void CompositeShapeRigidBody(const std::shared_ptr<Shape<RealType>> &shape, const std::shared_ptr<RigidBody<RealType>> &rigidbody)
        {
        ...
        void Print() const
        {
            KIRI_LOG_INFO("RigidBody mass={0}; inv mass={1}; density={2}", mMass, mInverseMass, mDensity);
        }
    ...
    private:
        ...
        std::weak_ptr<Shape<RealType>> mShape;
    };
